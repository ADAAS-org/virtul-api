...
var VAPIConnectorsManager = /** @class */ (function () {
    function VAPIConnectorsManager() {
        this.connectors = new Map();
    }
    VAPIConnectorsManager.prototype.getConnector = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            var target, newConnector;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        target = this.connectors.get(JSON.stringify(params));
                        if (!!target) return [3 /*break*/, 2];
                        return [4 /*yield*/, this["import"](params)];
                    case 1:
    ...
    VAPIConnectorsManager.prototype.getNewConnector = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, this["import"](params)];
            });
        });
    };
    VAPIConnectorsManager.prototype["import"] = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                params;
    ...
    VAPIConnectorsManager.prototype.download = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
